                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="input-area">
                            ...
                            <div class="relative">
                                <input type="text" id="price" name="price" class="form-control"
                                    placeholder="Enter price " value="{{ old('price', $plan->price) }}" required>
                        ...
                        <div class="input-area">
                            ...
                            <div class="relative">
                                <input type="number" id="duration" name="duration" class="form-control"
                                    placeholder="Enter duration " value="{{ old('duration', $plan->duration) }}" required>
                        ...
                        <div class="input-area">
                            ...
                            <select id="duration_unit" name="duration_unit" class="form-control" required>
                                ...
                                <option value="days" {{ old('duration_unit', $plan->duration_unit) == 'days' ? 'selected' : '' }}>Day(s)</option>
                                <option value="month" {{ old('duration_unit', $plan->duration_unit) == 'month' ? 'selected' : '' }}>Month(s)</option>
                                <option value="year" {{ old('duration_unit', $plan->duration_unit) == 'year' ? 'selected' : '' }}>Year(s)</option>
                            </select>
                        ...
                        <div class="input-area">
                            ...
                            <select name="status" class="form-control" required>
                                ...
                                <option value="1" {{ old('status', $plan->status) == '1' ? 'selected' : '' }}>
                                    Active
                                </option>
                                <option value="0" {{ old('status', $plan->status) == '0' ? 'selected' : '' }}>
                                    Inactive
                                </option>
                            </select>
                            <iconify-icon class="absolute right-3 bottom-3 text-xl dark:text-white z-10"
                        ...
                        <div class="input-area">
                            ...
                            <div class="relative">
                                <input type="number" id="number_of_visits" name="number_of_visits" class="form-control"
                                    placeholder="Enter number  of visits " value="{{ old('number_of_visits', $plan->number_of_visits) }}"
                                    required>
                                <x-input-error :messages="$errors->get('number_of_visits')" class="mt-2" />
                            </div>
                        </div>
                        {{-- number_of_visits end --}}

                        {{-- description start --}}
                        <div class="input-area">
                            <label for="description" class="form-label">{{ __('Description') }}</label>
                            <div class="relative">
                                <textarea id="description" name="description" class="form-control" placeholder="Enter plan description">{{ old('description', $plan->description) }}</textarea>
                                                ...
                                                <div class="flex items-center justify-between gap-x-3">
                                                    ...
                                                    <div class="flex items-center mr-2 sm:mr-4 mt-2 space-x-2">
                                                        <label
                                                            ...
                                                            <input name="services[]"
                                                                @if (in_array($service->id, old('services', $plan->services->pluck('id')->toArray()))) checked @endif
